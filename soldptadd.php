...
<fieldset> 
   <input type="text" name="id" placeholder="Enter sales id" style="width:100%;height:30px;
    border: 2px solid rgb(152, 116, 112); border-radius:5px;  background:transparent;" required>
  <br><br>
  <input type="text" name="csid" placeholder="Enter customer id" style="width:100%;height:30px;
    border: 2px solid rgb(152, 116, 112); border-radius:5px;  background:transparent;" required>
  <br><br>
...
$sql = "INSERT INTO sold_pets( sd_id,pet_id,cs_id)
VALUES ('$id','$pet_id','$cs_id')";
